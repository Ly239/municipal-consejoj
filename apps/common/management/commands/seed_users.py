...
Crea un usuario para cada rol: Superadmin, Administrator, Employee, ContentManager, Viewer.
"""
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.create_user('root', 'admin123', GROUP_SUPERADMIN, 'Root', 'Superuser', 'root@consejo.local','00000000')
